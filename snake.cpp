    ...
    switch (moveDirection) {
        ...
        case MoveLeft:
            ...
            if(asnake.front().first>0)
                asnake.push_front(std::make_pair(asnake.front().first-1,asnake.front().second));
            else 
        ...
        case MoveUp:
            ...
            if(asnake.front().second>0)
                asnake.push_front(std::make_pair(asnake.front().first,asnake.front().second-1));
            else 
...
bool Snake::not_confused(Direction A,Direction B){
   if ( A == B )
       ...
       return false;
   else if ( (A == MoveLeft && B==MoveRight) || ( A == MoveRight && B==MoveLeft))
       return false;
   else
       return true;
}
